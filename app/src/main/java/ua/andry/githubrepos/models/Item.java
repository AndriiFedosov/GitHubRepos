...
public class Item {
    ...
    public Item withStargazersCount(int stargazersCount) {
        this.stargazersCount = stargazersCount;
        return this;
    }
    ...
    public Item withWatchersCount(int watchersCount) {
        this.watchersCount = watchersCount;
        return this;
    }
    ...
    public Item withForksCount(int forksCount) {
        this.forksCount = forksCount;
        return this;
    }
    ...
    public Item withOpenIssuesCount(int openIssuesCount) {
        this.openIssuesCount = openIssuesCount;
        return this;
    }
    ...
    public Item withForks(int forks) {
        this.forks = forks;
        return this;
    }
    ...
    public Item withOpenIssues(int openIssues) {
        this.openIssues = openIssues;
        return this;
    }
    ...
    public Item withWatchers(int watchers) {
        this.watchers = watchers;
        return this;
    }
